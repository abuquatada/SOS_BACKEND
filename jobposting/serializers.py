...
class JobPostingSerializer(serializers.ModelSerializer):
    ...
    created_by = serializers.PrimaryKeyRelatedField(queryset=Recruiters.objects.all())
...
class JobPostingAggregationSerializer(serializers.Serializer):
    month = serializers.DateField()
    count = serializers.IntegerField()

class JobPostingCountByIndustrySerializer(serializers.Serializer):
